        ...
        <Card class="card">
          ...
          <template #content>
            ...
            <div class="question-box">
              ...
              />
              <div class="actions">
                <Button label="Send" icon="pi pi-send" :loading="asking" :disabled="!canAsk" @click="askQuestion" />
              </div>
            </div>
          </template>
        </Card>
...
const filesCount = computed(() => uploadStatus.value?.total_files || uploadedFiles.value.length || 0);
